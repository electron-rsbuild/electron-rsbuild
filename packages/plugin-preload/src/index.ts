...
import { supportESM } from '../../core/src/electron';
import { resolveBuildOutputs } from '../../core/src/utils';
 ...
 * */
export function preloadPlugin(options?: ElectronPluginOptions): Plugin[] {
  return [
    {
